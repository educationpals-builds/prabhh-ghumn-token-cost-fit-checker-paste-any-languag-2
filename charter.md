...
This document records the builder's full calibration run: the pinned sample, traffic context, stakes, deadline, dial scores, verdict, flip condition, and demanded test.
...
*This charter anchors the checker's calibration. All dial scores, the verdict, and the flip condition trace back to this pinned sample and traffic mix.*
